...
#define NUMB_OF_CLIENT_PCF 1
    ...
    VehicleConfig Vehicle = {
        .frontLeft = {
            ...
            .connection = {
                .controllerJY01 = {
                    .vr = {.pinDriver = PINDRV_GPIO, .pinConfig = {.pinType = PIN_PWM, .pwmSettings = {.frequency = 5000, .resolution = 7, .channel = 0}, .pinAddress = {.PIN_GPIO = {.pin = 2}}}},
        ...
        .frontRight = {.controllerType = EngineControllerType::JY01, .connection = {.controllerJY01 = {.vr = {.pinDriver = PINDRV_GPIO, .pinConfig = {.pinType = PIN_PWM, .pwmSettings = {.frequency = 5000, .resolution = 7, .channel = 1}, .pinAddress = {.PIN_GPIO = {.pin = 13}}}}, .zf = {.pinDriver = PINDRV_PCF, .pinConfig = {.pinType = PIN_DIGITAL, .pinAddress = {.PIN_I2C = {.controllerId = 0, .port = 0x05}}}}, .signal = {.pinDriver = PINDRV_PCF, .pinConfig = {.pinType = PIN_DIGITAL, .pinAddress = {.PIN_I2C = {.controllerId = 0, .port = 0x06}}}}, .brake = {.pinDriver = PINDRV_PCF, .pinConfig = {.pinType = PIN_DIGITAL, .pinAddress = {.PIN_I2C = {.controllerId = 0, .port = 0x07}}}}}}},
        .rearLeft = {.controllerType = EngineControllerType::JY01, .connection = {.controllerJY01 = {.vr = {.pinDriver = PINDRV_GPIO, .pinConfig = {.pinType = PIN_PWM, .pwmSettings = {.frequency = 5000, .resolution = 7, .channel = 2}, .pinAddress = {.PIN_GPIO = {.pin = 14}}}}, .zf = {.pinDriver = PINDRV_PCF, .pinConfig = {.pinType = PIN_DIGITAL, .pinAddress = {.PIN_I2C = {.controllerId = 0, .port = 0x09}}}}, .signal = {.pinDriver = PINDRV_PCF, .pinConfig = {.pinType = PIN_DIGITAL, .pinAddress = {.PIN_I2C = {.controllerId = 0, .port = 0x0A}}}}, .brake = {.pinDriver = PINDRV_PCF, .pinConfig = {.pinType = PIN_DIGITAL, .pinAddress = {.PIN_I2C = {.controllerId = 0, .port = 0x0B}}}}}}},
        .rearRight = {.controllerType = EngineControllerType::JY01, .connection = {.controllerJY01 = {.vr = {.pinDriver = PINDRV_GPIO, .pinConfig = {.pinType = PIN_PWM, .pwmSettings = {.frequency = 5000, .resolution = 7, .channel = 3}, .pinAddress = {.PIN_GPIO = {.pin = 25}}}}, .zf = {.pinDriver = PINDRV_PCF, .pinConfig = {.pinType = PIN_DIGITAL, .pinAddress = {.PIN_I2C = {.controllerId = 0, .port = 0x0D}}}}, .signal = {.pinDriver = PINDRV_PCF, .pinConfig = {.pinType = PIN_DIGITAL, .pinAddress = {.PIN_I2C = {.controllerId = 0, .port = 0x0E}}}}, .brake = {.pinDriver = PINDRV_PCF, .pinConfig = {.pinType = PIN_DIGITAL, .pinAddress = {.PIN_I2C = {.controllerId = 0, .port = 0x0F}}}}}}},
